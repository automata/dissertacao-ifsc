...
% revisar abstract
% x confirmar método de validação cruzada (cálculo de autovetores?) para LDA
% ver o livro de deleuze sobre ``espaço criativo''
% x rever resultados
% ler toda a dissertação
...
% x atributos de complexidade
% x atributos espectrais
% figuras sem legendas
% x discutir que oposição e inovação
% x efeitos de borda e primeiras na oposição e inovação
% glossário
% x figura de dialética, opos e inov
...
inovação, grande oposição em momentos específicos de sua evolução (a
...
\caption{\label{tab:interpretacaoOpos} Possível interpretação, com base na história da Arte e características estéticas, para cada valor de oposição e inovação calculado.}\\
