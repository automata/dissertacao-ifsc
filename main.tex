...
%% [x] melhorar validação cruzada, incluindo explicação sobre % http://www.inf.ufrgs.br/~alvares/CMP259DCBD/avaliacao.pdf
%% [x] figuras ilustrando o processo todo na secao pertinente
%% [x] períodos na tabela de pintores
%% [x] rever texto ressaltando pontos fortes, principalmente resultados e conclusão
...
Depois chegou perto da cama, agarrou a cabeleira de Holoferne, e
...
Outra diferença é a pose alternativa para a época. Diferente dos
...
\multirow{6}{*}{\begin{tabular}[c]{@{}l@{}}Contraste (e.g. claro-escuro); \\ emoção ao invés da razão; movimento; \\ dramaticidade; sensualidade; \\ beleza; fantasia; \\ a verdade; o sagrado\end{tabular}} & Van Gogh  & \begin{tabular}[c]{@{}l@{}}Sensação; movimento; textura; cores; \\ uso da perspectiva e profundidade de uma \\ nova maneira; distorção\end{tabular} \\ \cline{2-3} 
                                                                                                                          ...
                                                                                                                          & Pollock   & Abstrato; pintura de ação, pura, expontânea                                                                                                         \\ \hline
\end{tabular}
}
\end{center}
