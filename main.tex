...
Fourier --- e.g.\ por um método numérico de diferenciação --- acaba
...
uma classe do grupo de treinamento (e.g.\ no caso deste estudo, as
...
esteja o mais próximo possível do número máximio de elementos para
...
Detalhes interessantes surgem dessa projeção e confirmam as hipóteses
...
série temporal. 
%Isso caracteriza novamente uma cena comum nas Artes,
