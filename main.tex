...
%% [x] tabela comparativa: barroco, movimento moderno (cada artista)
...
Há grande semelhança entre suas obras e as pinturas do mestre
italiano, como é possível observar na figura~\ref{fig:velazquez:velha} da obra
\textit{Velha Fritando Ovos}. Assim como Caravaggio, retrata a natureza como ela é, sua verdade é mais importante do que sua aparente beleza. Na pintura em destaque, há
...
da Galiléia} (figura~\ref{fig:rembrandt:tempestade}).  

\begin{figure}[ht!]
  \begin{center}
   \caption{\emph{A Tempestade no Mar da Galiléia} (Rembrandt van Rijn), c. 1633}
   \label{fig:rembrandt:tempestade}
    \includegraphics[width=0.6\textwidth]{figs/rembrandt_tempestade.png}
    \fonte{figrembrandt}
  \end{center}
\end{figure}
...
Dada uma imagem $I$ com $N_G$ níveis de cinza, sua matriz de co-ocorrência será
