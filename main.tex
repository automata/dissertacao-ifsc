...
%% [x] figuras ilustrando o processo todo na secao pertinente
%% [x] períodos na tabela de pintores
%% [ ] rever texto ressaltando pontos fortes, principalmente resultados e conclusão
%% [ ] correções para biblioteca
%% [x] traduzir todas as figuras e melhorá-las
